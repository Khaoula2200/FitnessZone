<template>
  <div>
    ...
    <div class="bradcaump_area">
      <div
        class="bg-fixed bradcaump_area bg_image--12 static-breadcaump contact-hero-area"
          ...
          <v-row>
            <v-col cols="12">
              <div class="text-center bradcaump_inner">
                ...
                <p>
                 Contact us today and let us bring your dream wedding to life.
                </p>
              </div>
            </v-col>
          </v-row>
    ...
    data() {
      return {
        ...
        addressContent: [
          {
            icon: "map-pin",
            desc1: "103 Lovebirds Avenue, Suite 144",
            desc2: "Roseville, CA 65778",
            isAddress: true,
          },
          {
            icon: "smartphone",
            num1: "+212 5 37 25 36 21",
            num2: "+212 5 37 25 36 21",
...
.wa-logo {
  ...
  .contact-hero-area {
    ...
    background-image: url(../assets/images/gallery/couple-about-1.jpg) !important;
