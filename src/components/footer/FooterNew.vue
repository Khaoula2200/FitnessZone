  ...
  <div class="content">
    <div class="top">
      <div class="logo-details">
        ...
        <span class="logo_name"><img class="wa-logo" slot="logo" src="../../assets/images/logo/white.png" /></span>
      </div>
    ...
    <div class="link-boxes">
      ...
      <ul class="box">
        <li class="link_name">What we offer</li>
        <li
          v-for="(link, i) in servicesList"
          :key="i"
          >
         <router-link :to="link.to">{{
                        link.title
      ...
      <ul class="box input-box">
        ...
        <li><input type="button" value="Subscribe" v-on:click="subscribe"></li>
      </ul>
    </div>
  </div>
